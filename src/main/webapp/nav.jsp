...
<!-- 		  </form> -->
	    ...
	    <div class="collapse navbar-collapse" id="navbar-collapse-id">
	      <ul id="menu-list-2" class="nav navbar-nav navbar-right">
			...
			</li><li id="user-menu-item" style="display:none">
			...
			</li><li id="logout-button" style="display:none">
	            <a class="navbar-link"><i class="fa fa-sign-out" aria-hidden="true"></i>&nbsp; Salir</a>
			</li><li id="login-button" class="" data-toggle="modal" data-target="#login-selector">
				<a class="navbar-link"><i class="fa fa-user" aria-hidden="true"></i>&nbsp; Entrar</a>
			</li><li class="" data-toggle="modal" data-target="#help">
